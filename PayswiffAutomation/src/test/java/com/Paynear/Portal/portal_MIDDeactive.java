...
public class portal_MIDDeactive {
	...
	public void Device_Assign() throws Exception {
		...
		//TestResultUtils.logger = TestResultUtils.extent.startTest("Portal MID DeActive");
		 ...
		 */
		try {
		if(library.gClick(objects.MID_Act1) == true) {
		...
		TestResultUtils.logger.log(LogStatus.PASS, "POS MID TID after DeActive 1" +TestResultUtils.logger.addScreenCapture(library.takescreenshot("POS MID TID after DeActive")));
	}
}
