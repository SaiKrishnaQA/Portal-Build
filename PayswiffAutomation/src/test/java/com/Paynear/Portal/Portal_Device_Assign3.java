...
public class Portal_Device_Assign3 {
	...
	public void Device_Assign() throws Exception {
		...
		*/
		...
		TestResultUtils.logger.log(LogStatus.PASS, "Devices are LIVE");
		...
		if(listDev.isEmpty()) {
			...
			TestResultUtils.logger.log(LogStatus.PASS, "All the Devices are Auto Configured");
