...
public class Portal_Reports {
	...
	public void Reports() throws Exception {
		...
		TestResultUtils.logger.log(LogStatus.FAIL, "Reports field in the Reports Screen : Failed");
	}
		...
		TestResultUtils.logger.log(LogStatus.FAIL, "ReportsCrumb field in the Reports Screen : Failed");
	}
		...
		TestResultUtils.logger.log(LogStatus.FAIL, "Sales Transaction Report field in the Reports Screen : Failed" +TestResultUtils.logger.addScreenCapture(library.takescreenshot("Sales Transaction Report Filed was not seen")));
	}
		...
		TestResultUtils.logger.log(LogStatus.FAIL, "Settlement Detailed Report field in the Reports Screen : Failed" +TestResultUtils.logger.addScreenCapture(library.takescreenshot("Settlement Detailed Report Filed was not seen")));
	}
		...
		try {
			...
			if (library.gClick(objects.FT_SetSummaryViewBut) == true) {
				...
				TestResultUtils.logger.log(LogStatus.FAIL, "Settlement Detailed Report View Button was not clicked: Failed");
			}
		}
		catch (Exception exception) {
		...
		TestResultUtils.logger.log(LogStatus.FAIL, "Settlement Summary Report field in the Reports Screen : Failed" +TestResultUtils.logger.addScreenCapture(library.takescreenshot("Settlement Summary Report Filed was not seen")));
	}
