...
import com.payswiff.config.SeleniumNGSuite;
	...
	public class Fetch_MerchDetails {
		...
		public void TestMerch() throws Exception {
			...
			//To read the data from bulk upload sheet
			String Bulk_ReadFile = baseProjectPath.concat(Constants.BulkUpload); 
			ExcelData.SelFile(Bulk_ReadFile);
			
			//UserData= ExcelData.ReadData(2, 9);
