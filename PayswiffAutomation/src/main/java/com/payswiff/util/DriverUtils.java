...
public interface DriverUtils {
	 ...
	 *             the footlocker exception
	 */
	void sendKeysAction(Keys Key) throws Exception;
	 ...
	 *             the footlocker exception
	 */
	String takescreenshot(String scenario) throws Exception;
	 ...
	 *             the footlocker exception
	 */
	boolean gMouseHover(By strXpath) throws Exception;
	 ...
	 *             the footlocker exception
	 */
	boolean isElementNotPresent(By by) throws Exception;
	 ...
	 *             the footlocker exception
	 */
	int numberOfElementsPresent(By by) throws Exception;


	public void gNavToBrowser(String url) throws Exception;
	/**
	 * G click without checking enabled.
	 *
	 * @param elementLocator
	 *            the element locator
	 * @param text
	...
	public boolean gListFirstSelectedOption(By elementLocator) throws Exception;
	
	/**
	 * G select by visible value.
	 *
	 * @param strName
	 *            the str name
	 * @param strRadioValue
